...
def introForm_createView(request, *args, **kwargs):
    template_name = 'user/information_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def eduForm_createView(request, *args, **kwargs):
    template_name = 'user/education_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def expForm_createView(request, *args, **kwargs):
    template_name = 'user/experience_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def projectForm_createView(request, *args, **kwargs):
    template_name = 'user/project_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def skillForm_createView(request, *args, **kwargs):
    template_name = 'user/skill_create.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def portfolio_view(request, username, *args, **kwargs):
    template_name = 'user/portfolio.html'
    context = {}
...
def introForm_updateView(request, *args, **kwargs):
    template_name = 'user/update/information_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def eduForm_updateView(request, id, *args, **kwargs):
    template_name = 'user/update/education_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def expForm_updateView(request, id,  *args, **kwargs):
    template_name = 'user/update/experience_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def projectForm_updateView(request, id, *args, **kwargs):
    template_name = 'user/update/project_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def skillForm_updateView(request, id, *args, **kwargs):
    template_name = 'user/update/skill_update.html'
    context = {}
    user = request.user
    if not user.is_authenticated:
        #DO something
...
def login_view(request, *args, **kwargs): 
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, "user/loginRegister.html", {"message": "Invalid username or password. Please check again!"})
    else:
        return render(request, "user/loginRegister.html", {"message": ""})
...
def register_view(request, *args, **kwargs):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "user/loginRegister.html", {"message": "Password not confirmed/matching. Please enter again."})
        ...
        try:
            ...
            return render(request, "user/loginRegister.html", {"message": "Username already exists."})
